...
/*
 * KRUIZLY FINANCIAL KPI BASELINE
 * Historical closed accounting periods: July 2026 (50,540) & August 2026 (281,857)
...
async function loadManagerData() {
  try {
    ...
    if (
      ...
      (kpiRes.value?.success || kpiRes.value?.status === "success") &&
      kpiRes.value?.data
    ) {
